...
namespace Necromancy.Server.Packet.Area
{
    public class SendReviveExecute : ClientHandler
    {
        ...
        {
            //todo: needs checking whether player has enough cash or whatever else we come up with
            ...
            RecvReviveExecute reviveExecute = new RecvReviveExecute(0);
            ...
            client.character.mapId = (1001001); //illfalo port, main city, temple building.
